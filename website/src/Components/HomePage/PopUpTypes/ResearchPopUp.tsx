...
interface ResearchopUpState
{
    open: boolean
}

export class ResearchPopUp extends Component<ResearchPopUpProps, ResearchopUpState>
{
    constructor(props:ResearchPopUpProps)
    {
        super(props);
        this.state = 
        {
    ...
    render()
    {
        return (
            <div className="modal_info">
                <p className="modal_description">Affiliated with: Interaction Lab</p>
                ...
                <div className ="modal_links">
                    ...
                    <p className="otherLink"><a href="https://localhost:3000"> learn about the work </a></p>
                </div>
            </div>
        )
    }
